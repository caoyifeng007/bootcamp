...
library ClonesWithImmutableArgs {
    ...
    function clone(
        ...
        unchecked {
            ...
            // creationSize is 10 bytes, runtimeSize is 55 bytes
            // the total size of opcodes is 65 bytes, 0x41
            uint256 totalSize = 10 + 55 + extraLength;
            uint256 runtimeSize = 55 + extraLength;
            uint256 dataPtr;
            uint256 ptr;
            ...
            assembly {
                ...
                mstore(add(ptr, 0x01), shl(240, runtimeSize)) // size of the contract running bytecode (16 bits)
            ...
            // yul course 8. How Solidity uses memory
            // solhint-disable-next-line no-inline-assembly
            assembly {
                dataPtr := add(data, 32)
            }
            ...
            // solhint-disable-next-line no-inline-assembly
            assembly {
                instance := create(0, ptr, totalSize)
            }
