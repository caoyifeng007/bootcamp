...
21,000 + 22,100 * 5 + 200 = 131,700

slot 2存长度，在别的位置又开辟两个slot存字符串本身的内容，所以比上一个例子额外多消耗两个0->non-zero的gas 
